    ...
    <>
      <div className={styles.topwindowsbar}>
        <div className={styles.toolbar}>
          <p className={styles.toolbaritem}>Файл</p>
          <p className={styles.toolbaritem}>Правка</p>
          <p className={styles.toolbaritem}>Вид</p>
          {programType !== App.OUTLOOK ? (
            <div style={{ display: "flex" }}>
              <p className={styles.toolbaritem}>Избранное</p>
              <p className={styles.toolbaritem}>Сервис</p>
            </div>
          ) : (
            <div style={{ display: "flex" }}>
              <p className={styles.toolbaritem}>Вставка</p>
              <p className={styles.toolbaritem}>Формат</p>
              <p className={styles.toolbaritem}>Инструменты</p>
              <p className={styles.toolbaritem}>Сообщение</p>
            </div>
          )}
          <p className={styles.toolbaritem}>Помощь</p>
        </div>
